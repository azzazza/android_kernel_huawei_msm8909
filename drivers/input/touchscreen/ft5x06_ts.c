			...
			struct ft5x06_ts_platform_data *pdata)
{
	...
	pdata->psensor_support = of_property_read_bool(np, "focaltech,psensor-support"); /* error compile - azzazza*/

    pdata->gesture_support = of_property_read_bool(np, "focaltech,gesture-support"); /* error compile - azzazza*/
